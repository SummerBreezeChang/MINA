    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <header className="border-b border-white/10 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4">
          <h1 className="text-2xl font-bold text-white">MINA - Startup Career Scout</h1>
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-white mb-6">Find Startups with Hiring Signals</h2>
        ...
        {results.length > 0 && (
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-6">Found {results.length} Startups with Hiring Signals</h3>
              ...
              {results.map((company, idx) => (
                <div key={idx} className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h4 className="text-xl font-bold text-white mb-2">{company.company}</h4>
                  ...
                  <p className="text-white/70 text-sm mb-4">{company.description}</p>
